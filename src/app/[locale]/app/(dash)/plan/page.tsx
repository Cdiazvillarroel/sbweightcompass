const T = { en: { title: "My coach", body: "Your plan summary, meeting minutes and session notes from Sebastián will appear here." }, es: { title: "Mi coach", body: "El resumen de tu plan, las minutas y las notas de sesión de Sebastián aparecerán aquí." } };
