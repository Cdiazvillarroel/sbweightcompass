const T = { en: { title: "Movement", body: "Your training plan, exercise library and activity tracking are on the way." }, es: { title: "Movimiento", body: "Tu plan de entrenamiento, biblioteca de ejercicios y seguimiento de actividad están en camino." } };
